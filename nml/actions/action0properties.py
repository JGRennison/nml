...
properties[0x08] = {
    ...
    "allow_rocks_in_desert":       {"size": 1, "mapped_property": "global_allow_rocks_in_desert"},
}
# fmt: on
...
properties[0x0E] = {
    ...
    "style_lookahead_single_signal_only": {"size": 1, "mapped_property": "signals_style_lookahead_single_signal_only"},
...
properties[0x0F] = {
    ...
    "map_tile_type":          {"size": 1, "mapped_property": "object_viewport_map_tile_type"},
    "map_tile_subtype":       {"size": 2, "mapped_property": "object_viewport_map_tile_subtype"},
}
# fmt: on
    ...
    def write(self, file):
        ...
        for item in self.items:
            ...
            if val > 0xFF or val < 0:
                raise generic.ScriptError(description + " list items must be bytes", value.pos)
            file.print_byte(val)
        file.newline()
