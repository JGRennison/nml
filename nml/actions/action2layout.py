...
from nml.actions import action0, action1, action2, action2real, action2var, action6, action7, actionD, real_sprite
...
def get_layout_action2s(spritelayout, feature):
    ...
    if feature >= 0xE0 and len(actions) > 0:
        action7.skip_action_array_feature_test(actions, 6, "feature_id_mapping feature test (layout Action 2)")
