...
# Features using sprite groups directly: vehicles, canals, cargos, signals, railtypes, airports, roadtypes, tramtypes, new landscape
features_sprite_group = [0x00, 0x01, 0x02, 0x03, 0x05, 0x0B, 0x0D, 0x0E, 0x10, 0x12, 0x13, 0xE1]
# Features using sprite layouts: stations, houses, industry tiles, objects, airport tiles, and road stops
features_sprite_layout = [0x04, 0x07, 0x09, 0x0F, 0x11, 0xE0]
