...
# Features using sprite groups directly: vehicles, canals, cargos, signals, railtypes, airports, roadtypes, tramtypes
features_sprite_group = [0x00, 0x01, 0x02, 0x03, 0x05, 0x0B, 0x0D, 0x0E, 0x10, 0x12, 0x13]
